        ...
        if (response) {
            ...
            $.each(response, function(index, order) {
                ...
                table +=
                    ...
                    " Rs</td>" +
                    '<td><span class="btn btn-xs btn-warning order-details">Details</span></td>' +
...
$(document).on("click", ".order-details", function() {
    ...
    window.location =
        "C:/Users/soniv/Desktop/mini-store-management/ui/order-details.html?order_id=" +
        order_id;
});
...
$(document).on("click", ".delete-order", function() {
    ...
    var isDelete = confirm("Are you sure to delete " + tr.data('customer_name') + " item?");
    if (isDelete) {
